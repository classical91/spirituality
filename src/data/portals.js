...
export const portals = [
  ...
  },
  {
    ...
    path: '/self-concept',
    icon: '◐',
    badge: 'Language Studio',
    badgeColor: 'rgba(34,211,238,0.12)',
    badgeBorder: 'rgba(34,211,238,0.30)',
    badgeText: '#a5f3fc',
    title: 'Self-Concept\nLanguage Studio',
    titleFlat: 'Self-Concept Language Studio',
    description:
      'Turn messy inner wording into clean identity language — test sentences, diagnose tense and voice, and build native-sounding self-concept phrases.',
    keywords: ['Identity', 'Affirmations', 'Self-Concept', 'Language'],
    searchTerms: [
      'self-concept',
      'identity',
      'affirmations',
    ...
    cta: 'Enter Portal',
    ctaColor: '#67e8f9',
    iconBg: 'linear-gradient(135deg, rgba(34,211,238,0.35), rgba(139,92,246,0.2))',
  ...
  },
  {
    ...
    description:
      'A dedicated daily portal for Living in the End, SATS, revision, and check-ins to stay aligned.',
