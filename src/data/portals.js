...
export const portals = [
  ...
  },
  {
    ...
    description:
      "A focused dashboard for the moments a connection feels confusing — mixed signals, red flags, texting urges, standards, and the question: does this match the love I say I'm living in?",
    keywords: ['Security', 'Red Flags', 'Standards', 'Communication'],
    searchTerms: [
      'relationship',
      'relationships',
      'clarity',
