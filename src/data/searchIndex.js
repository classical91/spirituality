...
export const searchIndex = [
  ...
  { id: 'nev-phrase',        portalId: 'neville', title: 'Self-Concept Language Studio', summary: 'Test a phrase for present tense, passive voice, and identity strength — then rewrite it into native I AM language.', tags: ['phrase','self-talk','tool','analyzer','affirmation','i am','identity language','present tense','passive voice','rewrite','language studio'], lens: 'Symbolic' },
