...
export const searchIndex = [
  ...
  { id: 'rel-redflags',       portalId: 'relationships', section: 'reading-red-flags',   title: 'Reading Red Flags',                summary: 'A red flag is information, not an accusation — it tells you who someone is, not who they could be.', tags: ['red flags','warning signs','green flags','patterns','safety','potential'], lens: 'Reflection' },
  { id: 'rel-love-bombing',   portalId: 'relationships', section: 'love-bombing',        title: 'Love Bombing',                     summary: 'Intensity that arrives too fast is a strategy, not a depth of feeling.',                       tags: ['love bombing','red flag','intensity','manipulation','pacing','rushing'], lens: 'Reflection' },
  { id: 'rel-control',        portalId: 'relationships', section: 'control-and-isolation', title: 'Control & Isolation',            summary: 'Care that shrinks your world is not care — it is a leash with a soft handle.',                 tags: ['control','isolation','red flag','coercion','monitoring','freedom'], lens: 'Reflection' },
  { id: 'rel-gaslighting',    portalId: 'relationships', section: 'gaslighting',         title: 'Gaslighting & Rewriting Reality',  summary: 'If you keep leaving conversations doubting your own memory, that doubt is the injury.',        tags: ['gaslighting','red flag','manipulation','reality','memory','doubt'], lens: 'Reflection' },
  { id: 'rel-contempt',       portalId: 'relationships', section: 'contempt-and-criticism', title: 'Contempt & Criticism',          summary: 'Contempt is criticism aimed at who you are, not what happened — and it is corrosive.',         tags: ['contempt','criticism','red flag','disrespect','mockery','character'], lens: 'Reflection' },
  { id: 'rel-possessiveness', portalId: 'relationships', section: 'jealousy-and-possessiveness', title: 'Jealousy & Possessiveness', summary: 'Possessiveness wears the costume of passion — but it is about ownership, not love.',           tags: ['jealousy','possessiveness','red flag','control','trust','insecurity'], lens: 'Reflection' },
  { id: 'rel-future-faking',  portalId: 'relationships', section: 'future-faking',       title: 'Future-Faking & Broken Words',     summary: 'Promises are cheap; patterns are the truth. Watch what is done, not what is pledged.',         tags: ['future-faking','red flag','promises','broken words','patterns','follow-through'], lens: 'Reflection' },
