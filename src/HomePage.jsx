...
export default function HomePage({ onNavigate }) {
  ...
  const portals = [
    ...
    },
    {
      ...
      badgeText: '#ddd6fe',
      title: 'Neville\nAlignment Portal',
      description: 'A dedicated daily portal for Living in the End, SATS, revision, and check-ins to stay aligned.',
      keywords: ['SATS', 'Revision', 'Identity', 'Mental Diet'],
      cta: 'Enter Portal',
      ctaColor: '#c4b5fd',
      iconBg: 'linear-gradient(135deg, rgba(139,92,246,0.4), rgba(59,130,246,0.2))',
